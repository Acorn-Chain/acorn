...
import (
	...
	custombank "github.com/acorn-chain/acorn/x/bank"
	custombankkeeper "github.com/acorn-chain/acorn/x/bank/keeper"
	customfeegrantmodule "github.com/acorn-chain/acorn/x/feegrant/module"
	custommint "github.com/acorn-chain/acorn/x/mint"
	custommintkeeper "github.com/acorn-chain/acorn/x/mint/keeper"
	...
	"github.com/acorn-chain/acorn/docs"

	acornmodule "github.com/acorn-chain/acorn/x/acorn"
	...
	// evmutil from kava
	evmutil "github.com/acorn-chain/acorn/x/evmutil"
	evmutilkeeper "github.com/acorn-chain/acorn/x/evmutil/keeper"
	evmutiltypes "github.com/acorn-chain/acorn/x/evmutil/types"
...
func New(
	...
	app.AcornKeeper = acornmodulekeeper.NewKeeper(
		appCodec,
		keys[acornmoduletypes.StoreKey],
		keys[acornmoduletypes.MemStoreKey],
		app.GetSubspace(acornmoduletypes.ModuleName),
	)

	app.BankKeeper = custombankkeeper.NewBaseKeeper(
		appCodec, keys[banktypes.StoreKey], app.AccountKeeper, internal.MergeExcludeAddrs(app.ModuleAccountAddrs()), govModAddress, app.AcornKeeper,
	)
	...
	app.MintKeeper = custommintkeeper.NewKeeper(
		...
		app.AccountKeeper, app.BankKeeper, app.AcornKeeper, authtypes.FeeCollectorName,
		govModAddress,
	)
	...
	acornModule := acornmodule.NewAppModule(appCodec, app.AcornKeeper)
	...
	// acornPrefix := sdk.GetConfig().GetBech32AccountAddrPrefix()
	// wasmHooks := ibc_hooks.NewWasmHooks(app.IBCHooksKeeper, &app.WasmKeeper, acornPrefix) // The contract keeper needs to be set later
