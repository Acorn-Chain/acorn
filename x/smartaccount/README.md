...
# x/smartaccount
- `types/acornchain` is deprecated, used for **v0.7.0** migration only, and will be removed later. 

[1]: https://cosmwasm.com/
[2]: https://github.com/acorn-chain/smart-account-sample/
[3]: https://github.com/CosmWasm/wasmd/blob/main/x/wasm/keeper/msg_server.go#L79-L110
[4]: https://github.com/cosmos/cosmos-sdk/blob/main/x/auth/types/account.go