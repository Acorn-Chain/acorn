...
import (
	...
	"github.com/acorn-chain/acorn/x/smartaccount/keeper"
...
func (s *KeeperTestSuite) TestActivateAccount() {
	for _, tc := range []struct {
		...
		{
			// error msg
			accountAddress: "acorn1dkgyvk8zfn5vqg40qw0rhk972ugjppaeenqclwa6f0nsvzmx8mmsnggzpx", // not inactivate smartaccount address
			codeID:         1,
			err:            true,
		},
		{
...
func (s *KeeperTestSuite) TestRecoverAccount() {
	...
	for _, tc := range []struct {
		...
		},
		{
			...
			accountAddress: "acorn1dkgyvk8zfn5vqg40qw0rhk972ugjppaeenqclwa6f0nsvzmx8mmsnggzpx", // not activated smartaccount address
			err:            true,
		},
		{
