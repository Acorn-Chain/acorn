...
// MockAcornKeeper is a mock of AcornKeeper interface.
type MockAcornKeeper struct {
	ctrl     *gomock.Controller
	recorder *MockAcornKeeperMockRecorder
}

// MockAcornKeeperMockRecorder is the mock recorder for MockAcornKeeper.
type MockAcornKeeperMockRecorder struct {
	mock *MockAcornKeeper
}

// NewMockAcornKeeper creates a new mock instance.
func NewMockAcornKeeper(ctrl *gomock.Controller) *MockAcornKeeper {
	mock := &MockAcornKeeper{ctrl: ctrl}
	mock.recorder = &MockAcornKeeperMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockAcornKeeper) EXPECT() *MockAcornKeeperMockRecorder {
	return m.recorder
}

// GetExcludeCirculatingAddr mocks base method.
func (m *MockAcornKeeper) GetExcludeCirculatingAddr(ctx types.Context) []types.AccAddress {
	m.ctrl.T.Helper()
...
func (mr *MockAcornKeeperMockRecorder) GetExcludeCirculatingAddr(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetExcludeCirculatingAddr", reflect.TypeOf((*MockAcornKeeper)(nil).GetExcludeCirculatingAddr), ctx)
}

// GetMaxSupply mocks base method.
func (m *MockAcornKeeper) GetMaxSupply(ctx types.Context) string {
	m.ctrl.T.Helper()
...
func (mr *MockAcornKeeperMockRecorder) GetMaxSupply(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMaxSupply", reflect.TypeOf((*MockAcornKeeper)(nil).GetMaxSupply), ctx)
}
