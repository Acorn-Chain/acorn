...
import (
	"cosmossdk.io/math"
	custommint "github.com/acorn-chain/acorn/x/mint/types"
...
type Keeper struct {
	...
	acornKeeper    custommint.AcornKeeper
}
...
func NewKeeper(
	...
	acornKeeper custommint.AcornKeeper, feeCollectorName string, authority string,
) Keeper {
	return Keeper{
...
func (k Keeper) GetMaxSupply(ctx sdk.Context) string {
	return k.acornKeeper.GetMaxSupply(ctx)
}

//func (k Keeper) GetExcludeCirculatingAddr(ctx sdk.Context) []sdk.AccAddress {
//	return k.acornKeeper.GetExcludeCirculatingAddr(ctx)
//}
