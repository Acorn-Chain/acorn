...
import (
	...
	"cosmossdk.io/math"
	"github.com/acorn-chain/acorn/tests"
	minttypes "github.com/cosmos/cosmos-sdk/x/mint/types"

	"github.com/acorn-chain/acorn/x/mint/keeper"
	minttestutil "github.com/acorn-chain/acorn/x/mint/testutil"
...
type KeeperTestSuite struct {
	...
	acornKeeper    *minttestutil.MockAcornKeeper
...
func (s *KeeperTestSuite) SetupTest() {
	...
	acornKeeper := minttestutil.NewMockAcornKeeper(ctrl)
	...
	s.mintKeeper = keeper.NewKeeper(encCfg.Codec, key, stakingKeeper, accountKeeper, bankKeeper, acornKeeper, feeCollector, authority)

	s.stakingKeeper = stakingKeeper
	s.bankKeeper = bankKeeper
	s.accountKeeper = accountKeeper
	s.acornKeeper = acornKeeper
	s.pk = pk
}
...
func (s *KeeperTestSuite) TestMintCoins() {
	coins := sdk.NewCoins(sdk.NewCoin("uacorn", sdk.NewInt(1000000)))
